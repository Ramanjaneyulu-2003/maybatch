...
import com.adobe.aem.may.batch.core.schedulers.CustomSchedulerTask15;
...
public class UpdatePageContentServletTask15 extends SlingAllMethodsServlet {

    @Reference
    private CustomSchedulerTask15 customSchedulerService;
