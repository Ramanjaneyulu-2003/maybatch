...
@Component(
    ...
    property = {"process.label=Page Modification Logger Process"}
)
public class PageModificationLoggerProcessTask12 implements WorkflowProcess {

    private static final Logger LOG = LoggerFactory.getLogger(PageModificationLoggerProcessTask12.class);
    private static final String SERVICE_USER = "npservice";

    @Reference
    private ResourceResolverFactory resourceResolverFactory;

    @Override
    public void execute(WorkItem workItem, WorkflowSession aworkflowSessionrg1, MetaDataMap metaDataMap) throws WorkflowException {
