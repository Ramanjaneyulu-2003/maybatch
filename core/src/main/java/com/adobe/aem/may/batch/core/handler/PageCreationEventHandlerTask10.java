...
public class PageCreationEventHandlerTask10 implements EventHandler {

    private static final Logger LOG = LoggerFactory.getLogger(PageCreationEventHandlerTask10.class);
